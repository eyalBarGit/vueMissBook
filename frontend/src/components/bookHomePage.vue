    ...
    <div class="book">
      ...
      <label class="book__page book__page--2">
        <div class="book__page-front">
          <div class="page__content">
            <h1 class="page__content-book-title">Welcome!</h1>
            <h2 class="page__content-author">Eyal Bar</h2>

            <p class="page__content-credits">
              Hello and welcome to miss book website. Here you'll be able to
              find all books you're looking for.
              <!-- <span>Paul Krugman</span> -->
            </p>

            <p class="page__content-credits">
              All you got to do is simply click on
              <span>
                <router-link to="/book">
                  <v-btn @click.stop="" class="books-btn" color="deep-purple accent-1"> books</v-btn>
                </router-link>
              </span>
              and get yourself a book.
